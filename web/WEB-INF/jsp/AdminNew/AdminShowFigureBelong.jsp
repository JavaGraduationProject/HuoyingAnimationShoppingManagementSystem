            ...
            <div class="renzhejieshao">
                <div class="renzhejieshao2">
                    <div class="addrenzheButton">
                        <a href="${pageContext.request.contextPath}/toAddFigureBelong">新增手办分类</a>
                    </div>
                </div>
                <div>
                    <h2 class="AdminShowFigureBelong-H2Title">手办分类信息</h2>
                </div>
                <table class="AdminShowFigureBelong-table">
                    <tr>
                        <th>分类id</th>
                        <th>分类名称</th>
                        <th>操作选项</th>
                    </tr>
                    <c:forEach var="figureBelong" items="${requestScope.get('AdminAllFigureBelong')}">
                        <tr>
                            <td class="td1">${figureBelong.getFigureBelongId()}</td>
                            <td class="td2">${figureBelong.getFigureBelongName()}</td>
                            <td class="td3">
                                <a class="a1" href="${pageContext.request.contextPath}/toAdminUpdateFigureBelong?id=${figureBelong.getFigureBelongId()}">修改分类</a>
                                <a class="a2" href="${pageContext.request.contextPath}/AdminDeleteFigureBelongById/${figureBelong.getFigureBelongId()}">删除分类</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>

        ...
        <div class="ContentMain">
            <div class="renzhejieshao">
                <div class="AdminAddFigureBelong-div">
                    <div>
                        <h2 class="AdminAddFigureBelong-div-H2Title">修改分类信息</h2>
                    </div>
                    <form action="${pageContext.request.contextPath}/AdminUpdateFigureBelong">
                        <input type="hidden" name="figureBelongId" value="${updateFigureBelong.figureBelongId}" required/>
                        手办分类名称：
                        <input class="figureBelongContent" name="figureBelongName" type="text" value="${updateFigureBelong.figureBelongName}" required><br>

                        <input class="submitOK" type="submit" value="修改">

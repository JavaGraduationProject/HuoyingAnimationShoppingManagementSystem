...
<div class="whole">
    ...
    <div class="Content">
        ...
        <div class="ContentMain">
            <div class="addrenzhe">
                <form action="${pageContext.request.contextPath}/addrenzheupload2" enctype="multipart/form-data" method="post">
                    忍者名称：
                    <input name="renzheName" type="text" placeholder="请输入忍者名称"><br>

                    忍者链接：
                    <input name="renzheLink" type="text" placeholder="可不填"><br>
...
<%--                        <option value="宇智波一族">宇智波一族</option>--%>
<%--                        <option value="天才忍者">天才忍者</option>--%>
<%--                        <option value="人柱力">人柱力</option>--%>
                    </select><br>

                    忍者介绍：
                    <textarea cols="20" rows="10" name="renzheIntroduce" placeholder="这里是忍者的介绍说明"></textarea><br>

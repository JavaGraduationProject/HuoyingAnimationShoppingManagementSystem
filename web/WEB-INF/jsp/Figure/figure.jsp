...
<%--                </c:if>--%>
                <li><a href="${pageContext.request.contextPath}/toCart">购物车</a></li>
                <li><a href="${pageContext.request.contextPath}/toUserOrder">我的订单</a></li>
<%--                <li><a href="${pageContext.request.contextPath}/toUserOrderDateGroup">我的订单</a></li>--%>
                <li><a href="${pageContext.request.contextPath}/toUserShowApplyOrder">售后申请状态</a></li>
            </ul>
        </div>
    </div>
...
<%--                    </c:if>--%>
                ...
                <ul class="figureClassify">
                    <li><a href="${pageContext.request.contextPath}/toFigure"><div>全部忍者</div></a></li>
                    <li><a href="${pageContext.request.contextPath}/toxiaozuzhiFigure"><div>晓组织成员</div></a></li>
                    <li><a href="${pageContext.request.contextPath}/tolidaihuoyingFigure"><div>历代火影</div></a></li>
                    <li><a href="${pageContext.request.contextPath}/torendaoqirenFigure"><div>忍刀七人众</div></a></li>
                    <li><a href="${pageContext.request.contextPath}/tobamendunjiaFigure"><div>八门遁甲</div></a></li>
                    <li><a href="${pageContext.request.contextPath}/toSalesSortFigure"><div>销售量(降序)</div></a></li>
                </ul>
                <table>
...
<%--                                    <p>￥：${figure.figurePrice}&nbsp;&nbsp;&nbsp;销量：${figure.figureSales}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
<%--                                        <c:if test="${not empty UserOrAdmin}">--%>
<%--                                            <c:if test="${sessionScope.UserOrAdmin=='User'}">--%>
<%--                                                <a class="add-to-cart" href="${pageContext.request.contextPath}/addtoCart.do/${figure.figureId}">加入购物车</a>--%>
<%--                                            </c:if>--%>
<%--                                        </c:if>--%>
<%--                                    </p>--%>
<%--                                    <c:if test="${not empty UserOrAdmin}">--%>
...
<%--                                    </c:if>--%>
                    ...
                    <%--                    <c:forEach items="${requestScope.get('allrenzhe')}" var="renzhe" varStatus="status" step="2">--%>
                    <%--                        <c:if test="${not empty allrenzhe}">--%>
                    <%--                            <tr>--%>
                    <%--                                <c:forEach items="${requestScope.get('allrenzhe')}" var="renzhe" varStatus="status+1">--%>
                    <%--                                    &lt;%&ndash;                                <c:if test="${(status.index+1) mod 2 !=1}">&ndash;%&gt;--%>
                    <%--                                    <c:if test="${not empty allrenzhe[status.index].renzheImage}">--%>
                    <%--                                        <td><img src="/statics/images/renzhejianjie/${renzhe.renzheImage}" alt="图片显示失败"><a target="_blank" href="${renzhe.renzheLink}">${renzhe.renzheName}</a><p>${renzhe.renzheIntroduce}</p></td>--%>
                    <%--                                        &lt;%&ndash;                                <td><img src="/statics/images/renzhejianjie/${renzhe.renzheImage}" alt="图片显示失败"><a target="_blank" href="${renzhe.renzheLink}">${renzhe.renzheName}</a><p>${renzhe.renzheIntroduce}</p></td>&ndash;%&gt;--%>
                    <%--                                    </c:if>--%>
                    <%--                                    <c:if test="${not empty allrenzhe[status.index+1].renzheImage}">--%>
                    <%--                                        <td><img src="/statics/images/renzhejianjie/${renzhe.renzheImage}" alt="图片显示失败"><a target="_blank" href="${renzhe.renzheLink}">${renzhe.renzheName}</a><p>${renzhe.renzheIntroduce}</p></td>--%>
                    <%--                                        &lt;%&ndash;                                <td><img src="/statics/images/renzhejianjie/${renzhe.renzheImage}" alt="图片显示失败"><a target="_blank" href="${renzhe.renzheLink}">${renzhe.renzheName}</a><p>${renzhe.renzheIntroduce}</p></td>&ndash;%&gt;--%>
                    <%--                                    </c:if>--%>
                    <%--                                </c:forEach>--%>

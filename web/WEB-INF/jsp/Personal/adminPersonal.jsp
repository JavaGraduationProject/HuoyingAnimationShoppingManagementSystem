        ...
        <div class="ContentMain">
            <div class="personal">
                ...
                <div class="personalUpdate">
                    <form action="${pageContext.request.contextPath}/adminPersonalUpdate.do" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="hyrzResourceId" value="${AdminLoginSession.adminId}" required/>
                        用户昵称：
                        <input name="adminName" type="text" value="${AdminLoginSession.adminName}" required><br>

                        更改密码：
                        <input name="adminPass" type="password" value="${AdminLoginSession.adminPass}" required><br>

                        性别：
                        <label><input type="radio" name="adminSex" value="男" class="sexUpdate">男</label> &nbsp;|&nbsp;
                        <label><input type="radio" name="adminSex" value="女" class="sexUpdate">女</label><br>

                        年龄：
                        <input name="adminAge" type="text" value="${AdminLoginSession.adminAge}" required><br>

                        <div class="personalImgUpdate">
                            <img src="statics/images/User/${AdminLoginSession.adminAvatar}" id="cropedBigImg" value='custom' alt="lorem ipsum dolor sit" data-address='' title="自定义背景"/><br>
                        ...
                        籍贯：
                        <select name="adminProvince" id="province" onchange="getCity()" class="addressSelectProvince" required>
                        ...
                        <select name="adminCity" id="city" class="addressSelectCity" required> <option value="">城市</option></select><br>

                        个人介绍：
                        <textarea cols="20" rows="10" name="adminIntroduce" required>${AdminLoginSession.adminIntroduce}</textarea><br>

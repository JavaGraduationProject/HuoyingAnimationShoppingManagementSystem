        ...
        <div class="mainContent">
            ...
            <div class="registerContent">
                <form action="${pageContext.request.contextPath}/adminLogin" method="post" >
                    ...
                    用户名：<input name="adminName" id="username" type="text" placeholder="请输入用户名" onblur="checkUname()" required>
                    <span id="usernameSpan"></span><br>

                    <span class="xinghao">*</span>
                    密码：<input name="adminPass" id="pwd" type="password" placeholder="请输入密码" onblur="checkPwd()" required>
                    ...
                    <div class="adminAndLogin">
                        <label><a href="${pageContext.request.contextPath}/tologin">用户登录</a></label>
                    </div>
                </form>
            </div>

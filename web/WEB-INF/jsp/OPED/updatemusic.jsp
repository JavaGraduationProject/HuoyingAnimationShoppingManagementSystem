...
<div class="whole">
    ...
    <div class="Content">
        ...
        <div class="ContentMain">
            <div class="addmusic">
                <form action="${pageContext.request.contextPath}/updatemusic.do" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="musicId" value="${updatemusic.musicId}"/>
                    音乐名称：
                    <input name="musicName" type="text" value="${updatemusic.musicName}" required><br>

                    音乐链接：
                    <input name="musicLink" type="text" value="${updatemusic.musicLink}" required><br>

                    音乐所属：
                    <select name="musicBelong" required>
                        <option value="${updatemusic.musicBelong}">${updatemusic.musicBelong}</option>
                    ...
                    音乐资源：
                    <input name="musicRsc" type="file" required><br>

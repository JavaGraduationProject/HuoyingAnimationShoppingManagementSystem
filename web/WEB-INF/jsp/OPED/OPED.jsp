...
<div class="whole">
    ...
    <div class="navleftback">
        <div class="navleft">
            <ul>
                <li><a href="${pageContext.request.contextPath}/toOPED">OPED一览</a></li>
                <li><a href="${pageContext.request.contextPath}/toOPmusicclassify">OP一览</a></li>
                <li><a href="${pageContext.request.contextPath}/toEDmusicclassify">ED一览</a></li>
            </ul>
        </div>
    </div>
    <div class="Content">
        ...
        <div class="ContentMain">
            <div class="OPED">
                ...
                <ul class="OPEDshunxv">
                    <c:forEach items="${requestScope.get('allmusic')}" var="music">
...
<%--                            <li><p>${music.musicName}</p><p>音乐播放：</p><a target="_blank" href="${music.musicLink}"><img src="statics/images/OPED/音乐.png"></a><i>在线试听</i><audio src="statics/music/${music.musicResource}" controls="controls"></audio></li>--%>
                        </c:if>
                    </c:forEach>
                </ul>
            </div>

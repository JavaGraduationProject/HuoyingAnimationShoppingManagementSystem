    ...
    <div class="Content">
        ...
        <div class="ContentMain">
            <div class="renzhejieshao">
                <div class="ShowUserEvaluate">
                    <c:if test="${figureOrderEvaluate != null}">
                        <c:if test="${figureOrderEvaluate.getFigureImage()!=null}">
                            <img src="/statics/images/figure/${figureOrderEvaluate.getFigureImage()}"/>
                        </c:if>
                        <p>评论内容:${figureOrderEvaluate.getEvaluateContent()}</p>
                        <a href="${pageContext.request.contextPath}/deleteUserEvaluate/${figureOrderEvaluate.getOrderId()}">删除评价</a>
                    </c:if>
                    <c:if test="${figureOrderEvaluate eq null}">
                        <h1>评论已删除</h1>
                    </c:if>
                </div>
            </div>

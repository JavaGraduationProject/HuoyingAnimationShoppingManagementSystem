    ...
    <div class="Content">
        ...
        <div class="ContentMain">
            <div class="comment">
                ...
                <div id="qq">
                    <p>有什么新鲜事想告诉大家?</p>
                    <form action="${pageContext.request.contextPath}/fabiaoComment">
                        <%--                    <div class="message" contentEditable='true'></div>--%>
                        <input type="hidden" name="commentName" value="${loginSession.username}"/>
                        <input type="hidden" name="commentImg" value="${loginSession.userAvatar}"/>
...
<%--                                    <span class="time">2018-01-01</span>--%>
                                ...
                                <c:if test="${comment.commentName eq sessionScope.loginSession.username}">
